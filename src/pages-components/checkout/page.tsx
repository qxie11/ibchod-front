...
import { GoPayInfo } from '@/components/payment/gopay-info';
import { GoPayPaymentForm } from '@/components/payment/gopay-payment-form';
...
export default function CheckoutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'gopay' | 'manual'>('gopay');
  const {
    register,
    handleSubmit,
          ...
          <div className="space-y-6">
            <Card className="bg-card">
              ...
              <CardContent>
                <Tabs
                  value={paymentMethod}
                  onValueChange={(value) => setPaymentMethod(value as 'gopay' | 'manual')}
                >
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="gopay" className="flex items-center gap-2">
                  ...
                  <TabsContent value="gopay" className="mt-6">
                  ...
                  <TabsContent value="manual" className="mt-6">
                    <div className="space-y-4">
                      <h3 className="text-lg font-semibold">Fakturační údaje</h3>
                      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        >
                          {isOrderLoading
                            ...
                            : isSuccess
                              ? 'Objednávka odeslána!'
                              : `Objednat ${cartTotal.toLocaleString('cs-CZ')} Kč`}
                        </Button>
                        {isSuccess && (
