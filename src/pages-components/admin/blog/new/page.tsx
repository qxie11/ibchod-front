...
import { useCreateBlogArticleMutation } from '@/shared/lib/slices/blogApi';
...
export default function CreateBlogArticlePage() {
  ...
  const [createArticle, { isLoading: isSubmitting }] = useCreateBlogArticleMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createArticle(formDataToSend).unwrap();
  ...
  return (
    <AdminGuard>
      <Container className="py-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Vytvořit nový článek</CardTitle>
          </CardHeader>
          <CardContent>
