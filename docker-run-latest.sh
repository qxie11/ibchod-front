...
# Скрипт для запуска production окружения с latest тегом
...
# Тянем образ с latest тегом
echo "📥 Скачиваем образ dsx11/iobchod-store:latest..."
docker pull dsx11/iobchod-store:latest
